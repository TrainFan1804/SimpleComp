 ...
 */
@Deprecated
public class LexerScannerOld {

    private static LexerScannerOld staticLexerScanner;
     ...
     */
    public static LexerScannerOld createLexerScanner() {

        if (LexerScannerOld.staticLexerScanner == null) {

            LexerScannerOld.staticLexerScanner = new LexerScannerOld();
        }

        return LexerScannerOld.staticLexerScanner;
    }

    /**
     * Create a new lexer scanner.
     */
    private LexerScannerOld() {
